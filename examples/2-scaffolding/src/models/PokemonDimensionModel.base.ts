...
export const pokemonDimensionModelPrimitives = selectFromPokemonDimension().minimum.maximum.build()

export class PokemonDimensionModelSelector<PARENT> extends QueryBuilder<PARENT> {
