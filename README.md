...
All `.base` files generated by `mst-gql` should not be touched, as they probably need to be scaffolded again in the future. However, the model definitions themselves can be changed freely!
